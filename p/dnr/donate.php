...
<body>
  ...
  <section class="section">
    <div class="container">
      <h1 class="title has-text-centered">Charitable Organizations</h1>
      <hr>
      <div class="columns is-multiline">
        <?php 
          ...
          while ($row = $result->fetch_assoc()) {
            ...
            $notifQuery = "SELECT COUNT(*) AS notifCount FROM `tblconvo` WHERE is_read = 0 AND initiate_by = 'charity' AND org_id = '$org_id'";
            ...
            <div class="card-content">
              <div class="media">
                ...
                <div class="media-content">
                  <p class="title is-4"><?php echo $org_name; ?></p>
              ...
              <div class="content">
                <div class="buttons">
                  ...
                  <a href="donation.php?oid=<?php echo $org_id; ?>" class="button is-small is-link">Donate Now</a>
                  <a href="permit.php?oid=<?php echo $org_id; ?>" class="button is-small is-link">View Permit</a>
