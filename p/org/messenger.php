...
<body>
  ...
  <?php 
    ...
    // TODO CHECKING IF THE ORG IS NOT SEEN

    $query = "SELECT * FROM `tblconvo` WHERE donor_id = '$donor_id' AND org_id = '$org_id' ORDER BY timestamp ASC";
    ...
    foreach ($messages as $message) {
      if ($message['is_read'] == 0) {
        ...
        $updateQuery = "UPDATE `tblconvo` SET is_read = 1 WHERE convo_id = '$messageId' AND donor_id = '$donor_id' AND org_id = '$org_id' AND initiate_by = 'donor'";
    ...
    $getDonorText = "SELECT * FROM `tbldonors` WHERE donor_id = $donor_id";
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
      ...
      if (isset($_POST['msgbox'], $_POST['send'])) {
        ...
        if (empty($message) || $message == "" || $message == " ") {
          header("Location: messenger.php?did=$donor_id");
          die();
        }

        $insertQuery = "INSERT INTO `tblconvo` (donor_id, org_id, initiate_by, message, timestamp, is_read) VALUES ('$donor_id', '$org_id', 'charity', '$message', NOW(), '0')";
  ...
  <section class="hero is-success is-fullheight">
    <div class="hero-body">
      <div class="container">
        <a href="donors.php" class="button is-pulled-left is-link is-small">Back</a>
        ...
        <div class="columns is-mobile">
          ...
          <div class="media-left">
            <figure class="image is-64x64">
              ...
              ?>
                <img src="https://bulma.io/images/placeholders/64x64.png" alt="<?php echo $donor['donor_name'] . ' logo';?>">
              <?php 
                }
              ?>
            </figure>
          ...
          <div class="media-content">
            <p class="title is-4 has-text-black"><?php echo $donor['donor_name']; ?></p>
            <p class="subtitle is-6 has-text-black">Contact Person: <?php echo $donor['donor_contact_name']; ?></p>
            <hr>
          </div>
        </div>
            ...
            <div class="conversation">
              <?php 
                foreach ($messages as $message) {
                  $bubbleClass = ($message['initiate_by'] == 'donor') ? 'incoming charity-a' : 'outgoing charity-a';
                  $personName = ($message['initiate_by'] == 'donor') ? 'Donor' : 'You';
              ?>
